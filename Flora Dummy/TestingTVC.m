...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    activity.activityDescription = [NSString stringWithFormat:@"This is a test activity for the \"%@\" class.\n\nPlease use the next couple of pages for debugging purposes.", [selectedTest componentsSeparatedByString:@" - "][1]];
    activity.name = [NSString stringWithFormat:@"Test Activity -- %@", [selectedTest componentsSeparatedByString:@" - "][1]];
    ...
    else if ([selectedTest isEqualToString:@"Michael - DrawingVC"])
    {
        testSessionData = [NSMutableArray arrayWithObjects:
                           [NSDictionary dictionaryWithObjectsAndKeys:[NSArray arrayWithObjects:
                                                                       [NSDictionary dictionaryWithObjectsAndKeys:@"Please draw your name", @"Instructions", [NSNumber numberWithInt:1], @"Orientation", nil], nil], [NSNumber numberWithInteger:ActivityViewControllerTypeDrawingVC], nil],
                           [NSDictionary dictionaryWithObjectsAndKeys:[NSArray arrayWithObjects:
                                                                       [NSDictionary dictionaryWithObjectsAndKeys:@"Please draw your favourite number", @"Instructions", [NSNumber numberWithInt:0], @"Orientation", nil], nil], [NSNumber numberWithInteger:ActivityViewControllerTypeDrawingVC], nil], nil];
    }
