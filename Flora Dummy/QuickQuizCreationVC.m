...
-(IBAction)presentPopOver: (id)sender
{
    ...
    _quizPicker.modalPresentationStyle = UIModalPresentationPopover;
    _quizPicker.popoverPresentationController.barButtonItem = sender;
    [self presentViewController:_quizPicker animated:true completion:nil];
}
...
-(void)returnAnswers: (NSArray *)array andQuestion: (NSString *)q andCorrectIndex: (NSNumber *)n
{
    ...
    [_quizPicker dismissViewControllerAnimated:true completion:nil];
