...
class UIButton_Typical: UIButton
{
    override func setTitle(title: String?, forState state: UIControlState)
    {
        ...
        UILabel.outlineLabel(titleLabel!)
    }
    ...
    func setHighlighted(highlighted: Bool, animated: Bool)
    {
        ...
        highlighted == true ? animated == true ? highlightButton() : nonAnimatedHighlight() : animated == true ? unhighlightButton() : nonAnimatedUnHighlight()
    }
