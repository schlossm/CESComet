...
-(void)saveActivity: (id)sender
{
    ...
    _activityInfoVC.modalPresentationStyle = UIModalPresentationPopover;
    _activityInfoVC.popoverPresentationController.barButtonItem = sender;
    [self presentViewController:_activityInfoVC animated:true completion:nil];
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    NSInteger count = [self.pagesArray count];
...
-(void)finishSavingActivity: (Activity *)a
{
    ...
    // Dismiss screen
    [_activityInfoVC dismissViewControllerAnimated:true completion:nil];
    [self dismissViewControllerAnimated:YES completion:nil];
}
