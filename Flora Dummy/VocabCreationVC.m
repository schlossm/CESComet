...
-(IBAction)save
{
    ...
    correctIndex = [NSNumber numberWithInteger: correctIndexSegmentedControl.selectedSegmentIndex];
...
-(void)updateColors
{
    ...
    questionTextView.textColor = [ColorScheme currentColorScheme].primaryColor;
    questionTextView.backgroundColor = [ColorScheme currentColorScheme].secondaryColor;
    questionTextView.backgroundColor = [ColorScheme currentColorScheme].secondaryColor;
...
-(void)populateView
{
    ...
    for (int i = 0; i < answers.count; i++)
    {
        ...
        textField.tag = i;
        textField.backgroundColor = [ColorScheme currentColorScheme].primaryColor;
