...
-(void) updateColors
{
    ...
    [nextButton setTitleColor:[ColorScheme currentColorScheme].primaryColor forState:UIControlStateNormal];
    
    if (previousButton)
    {
        previousButton.backgroundColor = self.view.backgroundColor;
        [previousButton setTitleColor:[ColorScheme currentColorScheme].primaryColor forState:UIControlStateNormal];
    }
