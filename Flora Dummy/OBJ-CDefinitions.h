...
} DEPRECATED_MSG_ATTRIBUTE("Use UserType instead");
...
typedef NS_ENUM(NSInteger, ActivityViewControllerType)
{
    ...
    ActivityViewControllerTypeDrawingVC,
...
typedef NS_ENUM(NSInteger, DrawingVCOrientation)
{
    DrawingVCOrientationLandscape,
    DrawingVCOrientationPortrait
};
